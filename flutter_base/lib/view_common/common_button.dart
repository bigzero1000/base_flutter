...
class AppButtonWidget extends StatelessWidget {
    ...
    return Container(
        ...
        child: TextButton(
          style: TextButton.styleFrom(
            ...
            primary: textColor,
            backgroundColor: onPressed != null ? color : const Color(0xffB5B5B5),
          ),
          onPressed: onPressed,
          child: Stack(
            fit: StackFit.expand,
            children: [
              ...
              Center(
                  child: Padding(
                padding: _getPadding(
                    rightButtonAvailable: rightButtonAvailable,
                    leftButtonAvailable: leftButtonAvailable),
  ...
  EdgeInsets _getPadding(
      {bool rightButtonAvailable, bool leftButtonAvailable}) {
    if (rightButtonAvailable) {
